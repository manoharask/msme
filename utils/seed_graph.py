...
def main():
    ...
    print("\n" + "=" * 70)
    print("✅ GRAPH DATABASE SUCCESSFULLY SEEDED!")
    print("=" * 70)
    print("\n📊 Summary:")
    print("   • 35 Categories with ONDC L1/L2/L3 mapping")
    ...
    print("   • Payment terms & capacity data")
    print("\n🎯 Coverage:")
    print("   • 10 Sectors: Manufacturing, Agriculture, Healthcare, etc.")
    print("   • 20+ Cities across India")
    print("   • 4,195 Total SNP capacity slots")
    print("\n💡 Next Steps:")
